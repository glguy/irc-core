...
replyCodeInfoTable
  ...
  , (RPL_UNKNOWNMODES          , ReplyCodeInfo ErrorReply "unknown-modes")
  , (RPL_CANNOTSETMODES        , ReplyCodeInfo ErrorReply "cannot-set-modes")
  ...
  , (ERR_STARTTLS              , ReplyCodeInfo ErrorReply "err-start-tls")
  ...
  , (RPL_TARGUMODEG            , ReplyCodeInfo ErrorReply "targ-umodeg")
